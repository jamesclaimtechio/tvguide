...
The call appears in the [Review Queue](./08-review-queue.md).
...
- [Analysis & Scoring](./06-analysis-scoring.md) - How results are generated
- [Review Queue](./08-review-queue.md) - Managing flagged calls
- [Agents](./09-agents.md) - Agent-specific call views
- [Scorecards & Coaching](./10-scorecards-coaching.md) - Sending feedback to agents
