---
title: Campaigns
description: Creating and managing QA campaigns in TotalView AI
slug: campaigns
order: 12
---
...
When a call matches these rules, it appears in the [Review Queue](/review-queue).

> **Learn More**: [Review Queue](/review-queue) for managing flagged calls.
...
> **Learn More**: [Keywords](/keywords) for detailed keyword configuration.
...
> **Learn More**: [API Reference](/api-reference) for API integration.
...
- [Getting Started](/getting-started) - Creating your first campaign
- [Quality Checks](/quality-checks) - Configuring evaluation criteria
- [Uploading Calls](/uploading-calls) - Adding calls to campaigns
- [Review Queue](/review-queue) - Managing flagged calls
- [Agents](/agents) - Assigning agents to campaigns
- [Reports](/reports) - Generating campaign reports
