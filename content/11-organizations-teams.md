...
description: Multi-tenancy, roles, and member management in TotalView AI
slug: organizations-teams
order: 11
---
...
> **Learn More**: [Agents](/agents) for details on agent management and platform access.
...
- [Getting Started](/getting-started) - First login and setup
- [Campaigns](/campaigns) - Creating and managing campaigns
- [Agents](/agents) - Agent profiles and platform access
- [Troubleshooting](/troubleshooting) - Account access issues
